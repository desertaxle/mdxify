...
def parse_modules_with_inheritance(modules_to_process: list[str], include_internal: bool = False, verbose: bool = False) -> dict[str, dict[str, Any]]:
    ...
    all_modules = []
    if root_module:
        all_modules = find_all_modules(root_module, verbose=verbose)
